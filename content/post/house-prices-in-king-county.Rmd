...
packages: ['mlr3', 'mlr3learners', 'mlr3viz', 'mlr3filters', 'mlr3tuning', 'mlr3book', 'paradox', 'anytime', 'ggmap', 'GGally', 'mlr3db', 'mlr3proba', 'ranger']
---
...
```{r}
library(mlr3)
house_sales_prediction = data("kc_housing", package = "mlr3data")
```
