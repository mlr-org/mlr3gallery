...
# in this case we could also take the iris example from mlr3's dictionary of
...
We can change the hyperparameters either during construction or later through an active binding.

```{r}
print(learner1$param_set)
# set hyperpars during construction
learner2 = lrn("classif.rpart", predict_type = "prob", minsplit = 50)
# change hyperpars after construction
