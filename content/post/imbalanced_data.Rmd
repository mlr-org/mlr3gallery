...
However, one can also jointly tune the hyperparameter of the learner along with the imbalancy correction method by extending the search space with the learner's hyperparameters. 
