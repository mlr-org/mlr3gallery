...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-003, include=FALSE}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-006, warning=FALSE}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-018, warning=FALSE, eval = params$eval_all}
tuner$optimize(inst)
```

```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-019, echo = FALSE, eval = params$eval_all}
saveRDS(inst, "data/inst.rda")
```

```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-020, echo = FALSE}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-021}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-024, warning=FALSE, eval = params$eval_all}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-025, echo = FALSE, eval = params$eval_all}
saveRDS(bmr, "data/bmr.rda")
```

```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-026, echo = FALSE}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-029, message=FALSE}
task = tsk("german_credit")
```
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-030, error=TRUE, warning=FALSE}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-032}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-033, warning=FALSE}
