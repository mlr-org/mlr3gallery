...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-004, include=FALSE}
...
We instantiate a `Resampling` instance for this `r ref("Task")` to be able to compare resampling performance:
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-007, warning=FALSE}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-011}
...
This `GraphLearner` can be used for resampling -- like an ordinary `r ref("Learner")`:
