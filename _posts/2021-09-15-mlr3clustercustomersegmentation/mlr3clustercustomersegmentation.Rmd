---
title: "mlr3cluster_customer_segmentation"
description: |
...
```{r mlr3clustercustomersegmentation-001, include=FALSE}
...
```{r mlr3clustercustomersegmentation-002, echo=FALSE, cache=FALSE, message=FALSE, warning=FALSE}
set.seed(1)
library(knitr)
library(ggplot2)
...
```{r mlr3clustercustomersegmentation-003}
# import data
...
```{r mlr3clustercustomersegmentation-004}
df_RFM = df %>%
...
```{r mlr3clustercustomersegmentation-005}
...
```{r mlr3clustercustomersegmentation-006}
...
```{r mlr3clustercustomersegmentation-007, message=FALSE}
...
```{r mlr3clustercustomersegmentation-008, fig.height=4, fig.width=10, echo=FALSE}
...
```{r mlr3clustercustomersegmentation-009}
...
```{r mlr3clustercustomersegmentation-010, fig.height=4, fig.width=10}
...
```{r mlr3clustercustomersegmentation-011,fig.height=7, fig.width=7}
...
```{r mlr3clustercustomersegmentation-012}
df_RFM %>%
...
```{r mlr3clustercustomersegmentation-013, echo = FALSE}
theme_set(theme_bw())
```
...
```{r mlr3clustercustomersegmentation-014}
