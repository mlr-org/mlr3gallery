...
```{r 2020-07-27-bikesharing-demand-002}
# descriptive
library(ggplot2)
library(GGally)
library(ggrepel)
...
```{r 2020-07-27-bikesharing-demand-003, echo=FALSE}
tmp = tempfile()
...
```{r 2020-07-27-bikesharing-demand-006, echo=FALSE}
...
```{r 2020-07-27-bikesharing-demand-027, results="hide"}
kknn_learner = lrn("regr.kknn")
kknn_learner$param_set
```

```{r 2020-07-27-bikesharing-demand-028, echo=FALSE}
...
```{r 2020-07-27-bikesharing-demand-030, message = FALSE, eval = params$eval_all}
...
archive_kknn = at_kknn$archive$data[, .("regr.rmse", "regr.kknn.k", "regr.kknn.distance")]
```

```{r 2020-07-27-bikesharing-demand-031, echo = FALSE, eval = params$eval_all}
saveRDS(archive_kknn, "archive_kknn.rda")
```

```{r 2020-07-27-bikesharing-demand-032, echo = FALSE}
archive_kknn = readRDS("data/archive_kknn.rda")
```
...
```{r 2020-07-27-bikesharing-demand-033, echo=FALSE, fig.cap="RMSE on tuning grid of kknn autotuner"}
...
```{r 2020-07-27-bikesharing-demand-034, results="hide"}
...
```{r 2020-07-27-bikesharing-demand-036}
...
```{r 2020-07-27-bikesharing-demand-037, message = FALSE, eval = params$eval_all}
...
archive_rpart = at_rpart$archive$data[, c("regr.rmse", "regr.rpart.minsplit", "regr.rpart.cp")]
```

```{r 2020-07-27-bikesharing-demand-038, echo = FALSE, eval = params$eval_all}
saveRDS(archive_rpart, file = "data/archive_rpart.rda")
```

```{r 2020-07-27-bikesharing-demand-039, echo = FALSE}
archive_rpart = readRDS("data/archive_rpart.rda")
```
...
```{r 2020-07-27-bikesharing-demand-040, echo=FALSE, fig.cap="RMSE on tuning grid rpart learner"}
...
```{r 2020-07-27-bikesharing-demand-041, results="hide"}
...
```{r 2020-07-27-bikesharing-demand-043}
...
```{r 2020-07-27-bikesharing-demand-044, echo=FALSE, fig.cap="Feature importance in ranger learner"}
...
```{r 2020-07-27-bikesharing-demand-045}
...
```{r 2020-07-27-bikesharing-demand-047}
...
```{r 2020-07-27-bikesharing-demand-048, echo=FALSE, fig.cap="Search space for ranger autotuner"}
...
```{r 2020-07-27-bikesharing-demand-049, message = FALSE, eval = params$eval_all}
set.seed(123456)
...
archive_ranger = at_ranger$archive$data[, .(regr.rmse, importance.filter.nfeat, regr.ranger.mtry)]
```

```{r 2020-07-27-bikesharing-demand-050, echo = FALSE, eval = params$eval_all}
saveRDS(archive_ranger, "data/archive_ranger.rda")
```

```{r 2020-07-27-bikesharing-demand-051, echo = FALSE}
archive_ranger = readRDS("data/archive_ranger.rda")
```
...
```{r 2020-07-27-bikesharing-demand-052, echo=FALSE, fig.cap="RMSE on tuning grid ranger learner"}
...
```{r 2020-07-27-bikesharing-demand-053, message = FALSE, results = 'hide', eval = params$eval_all}
lrns = list(
...
```{r 2020-07-27-bikesharing-demand-054, echo = FALSE, eval = params$eval_all}
saveRDS(bmr_table, "data/bmr_table.rda")
```


```{r 2020-07-27-bikesharing-demand-055, echo = FALSE}
bmr_table = readRDS("data/bmr_table.rda")
```


```{r 2020-07-27-bikesharing-demand-056, echo=FALSE}
agg = bmr_table %>%
...
```{r 2020-07-27-bikesharing-demand-057, eval=long_run, warning=FALSE}
png("bmr.png")
...
```{r 2020-07-27-bikesharing-demand-058, fig.cap="Pipeline Learner", fig.width = 5, fig.height = 4.3, eval=FALSE}
...
```{r 2020-07-27-bikesharing-demand-059, message=FALSE, results='hide', eval=FALSE}
ps = ParamSet$new(list(
  p_int("branch.selection", lower = 1L, upper = 3L),
  p_int("targettrafosimple.regr.kknn.targetinverter.regr.kknn.k", lower = 1L, upper = 50L),
  p_int("targettrafosimple.regr.kknn.targetinverter.regr.kknn.distance", lower = 1L, upper = 3L),
  p_int("targettrafosimple.regr.rpart.targetinverter.regr.rpart.minsplit", lower = 1L, upper = 30L),
  p_dbl("targettrafosimple.regr.rpart.targetinverter.regr.rpart.cp", lower = 0.001, upper = 0.1),
  ParamFct$new("importance.filter.nfeat", levels = c("6", "9", "11")),
  p_int("importance.mtry", lower = 7L, upper = 11L)
))
...
```{r 2020-07-27-bikesharing-demand-060, eval=long_run}
...
```{r 2020-07-27-bikesharing-demand-061, echo=FALSE, eval=long_run}
saveRDS(multi_at_archiv, "multi_at_archiv.rda")
```


```{r 2020-07-27-bikesharing-demand-062, echo=FALSE, eval=!long_run}
multi_at_archiv = readRDS("multi_at_archiv.rda")
```

```{r 2020-07-27-bikesharing-demand-063, echo=FALSE}
...
```{r 2020-07-27-bikesharing-demand-064}
...
```{r 2020-07-27-bikesharing-demand-065, eval=long_run}
pred_train = at_ranger$predict(bike_task)
pred_test = at_ranger$predict_newdata(test)
```

```{r 2020-07-27-bikesharing-demand-066, echo=FALSE, message=FALSE, eval=long_run}
...
```{r 2020-07-27-bikesharing-demand-067, echo=FALSE, eval=!long_run}
...
```{r 2020-07-27-bikesharing-demand-068, warning=FALSE, echo=FALSE, fig.cap="Bike Sharing Demand: Forecast vs. Actual", fig.height=2.5}
...
```{r 2020-07-27-bikesharing-demand-069, warning=FALSE, echo=FALSE, fig.cap="Distribution of Bike Sharing demand over a month", fig.height=2}
