...
<!--
# FIXME: reiterate through figure numbers if you uncomment
...
```{r 2020-07-27-bikesharing-demand-007, echo=FALSE, fig.cap="Density estimates of the continuous variables in training data", fig.height=3.3}
#plot_density(train,
#  ncol = 3L,
#  ggtheme = theme_bw(),
#  theme_config = list(
...
In the right plot in Figure 5, we see that the distribution of our transformed `count` variable is much less
skewed than before.
...
```{r 2020-07-27-bikesharing-demand-030, message=FALSE, eval=long_run}
set.seed(123456)
...
```{r 2020-07-27-bikesharing-demand-031, echo=FALSE, eval=long_run}
saveRDS(archive_kknn, file = "archive_kknn.rds")
```


```{r 2020-07-27-bikesharing-demand-032, echo=FALSE, eval=!long_run}
archive_kknn = readRDS("archive_kknn.rds")
```

In Figure 8 we see the RMSE for the considered hyperparameter of the `kknn` autotuner.
...
```{r 2020-07-27-bikesharing-demand-037, message=FALSE, eval=long_run}
set.seed(123456)
...
```{r 2020-07-27-bikesharing-demand-038, echo=FALSE, eval=long_run}
saveRDS(archive_rpart, file = "archive_rpart.rds")
```


```{r 2020-07-27-bikesharing-demand-039, echo=FALSE, eval=!long_run}
archive_rpart = readRDS("archive_rpart.rds")
```

In Figure 9 we see the RMSE for the considered hyperparameter of the `rpart` autotuner.
...
```{r 2020-07-27-bikesharing-demand-049, message=FALSE, eval=long_run}
set.seed(123456)
...
```{r 2020-07-27-bikesharing-demand-050, echo=FALSE, eval=long_run}
saveRDS(archive_ranger, "archive_ranger.rds")
```


```{r 2020-07-27-bikesharing-demand-051, echo=FALSE, eval=!long_run}
...
```{r 2020-07-27-bikesharing-demand-053, message=FALSE, results='hide', eval=long_run}
lrns = list(
...
```{r 2020-07-27-bikesharing-demand-054, echo=FALSE, eval=long_run}
saveRDS(bmr_table, "bmr_table.rds")
```


```{r 2020-07-27-bikesharing-demand-055, echo=FALSE, eval=!long_run}
