...
```{r 2020-07-27-bikesharing-demand-056, message = FALSE, results = 'hide', eval = params$eval_all}
lrns = list(
...
```{r 2020-07-27-bikesharing-demand-057, echo = FALSE, eval = params$eval_all}
saveRDS(bmr, "data/bmr.rda")
```

```{r 2020-07-27-bikesharing-demand-058, echo = FALSE}
...
```{r 2020-07-27-bikesharing-demand-060, warning = FALSE, echo = FALSE}
...
```{r 2020-07-27-bikesharing-demand-061, fig.cap="Pipeline Learner", fig.width = 10, fig.height = 8.6}
...
```{r 2020-07-27-bikesharing-demand-062, message = FALSE, results = 'hide'}
search_space = ps(
...
```{r 2020-07-27-bikesharing-demand-063, eval = params$eval_all}
multi_at = auto_tuner(
...
```{r 2020-07-27-bikesharing-demand-064, echo = FALSE, eval = params$eval_all}
...
```{r 2020-07-27-bikesharing-demand-065, echo = FALSE}
...
```{r 2020-07-27-bikesharing-demand-067}
...
```{r 2020-07-27-bikesharing-demand-069, echo = FALSE, message = FALSE}
...
```{r 2020-07-27-bikesharing-demand-070, warning=FALSE, echo = FALSE, fig.cap="Bike Sharing Demand: Forecast vs. Actual", fig.height=2.5}
...
```{r 2020-07-27-bikesharing-demand-071, warning=FALSE, echo = FALSE, fig.cap="Distribution of Bike Sharing demand over a month", fig.height=2}
