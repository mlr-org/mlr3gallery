...
```{r 2020-07-27-bikesharing-demand-025, fig.cap="Relationship between atemp, windspeed and count by year", fig.width=10, fig.height=8, echo = FALSE}
autoplot(bike_task,
  type = "pairs",
...
In our modeling process, we consider three learners: `r ref("mlr_learners_classif.kknn", "kknn")`, `r ref("mlr_learners_classif.rpart", "rpart")`, `r ref("mlr_learners_classif.ranger", "ranger learner")`.
