---
title: "How to tune a preprocessing pipeline"
description: |
  How to build a simple preprocessing pipeline and tune it.
author:
  - name: Marc Becker
date: 03-12-2021
output:
...
This notebook and other case studies are available in the [mlr3gallery](https://mlr3gallery.mlr-org.com/). 
