...
```{r practical-tuning-series-tune-a-support-vector-machine-014, eval = FALSE}
...
```{r practical-tuning-series-tune-a-support-vector-machine-021, eval = FALSE}
instance = tune(
  method = "grid_search",
  task = task,
  learner = learner,
...
```{r practical-tuning-series-tune-a-support-vector-machine-030, eval = FALSE}
instance = tune(
  method = "grid_search",
  task = task,
  learner = learner,
...
```{r practical-tuning-series-tune-a-support-vector-machine-035, eval = FALSE}
