...
```{r practical-tuning-series-build-an-automated-machine-learning-system-006, fig.width=10, fig.height=10}
graph =
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-009, fig.width=10, fig.height=10}
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-012, eval = FALSE}
as.data.table(graph_learner$param_set)
```

```{r practical-tuning-series-build-an-automated-machine-learning-system-013, echo = FALSE}
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-014}
# branch
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-015, eval = params$eval_all}
instance = tune(
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-016, echo = FALSE, eval = params$eval_all}
saveRDS(instance, "data/instance_1.rda")
```

```{r practical-tuning-series-build-an-automated-machine-learning-system-017, echo = FALSE}
instance = readRDS("data/instance_1.rda")
```

The following shows a quick way to visualize the tuning results.

```{r practical-tuning-series-build-an-automated-machine-learning-system-018, fig.width=12, fig.height=4, layout="l-page"}
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-019}
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-020, eval = params$eval_all}
graph_learner = GraphLearner$new(graph)
graph_learner$param_set$values$branch.selection =
  to_tune(c("kknn", "svm", "ranger"))
graph_learner$param_set$values$kknn.k =
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-021, echo = FALSE, eval = params$eval_all}
saveRDS(rr, "data/rr_1.rda")
```


```{r practical-tuning-series-build-an-automated-machine-learning-system-022, echo = FALSE}
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-023, eval = FALSE}
extract_inner_tuning_results(rr)
```

```{r practical-tuning-series-build-an-automated-machine-learning-system-024, echo = FALSE, layout="l-body-outset"}
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-026, echo = FALSE}
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-027}
rr$aggregate()
```
