...
```{r practical-tuning-series-build-an-automated-machine-learning-system-014, echo = FALSE}
instance = readRDS("data/instance_1.rda")
```

```{r practical-tuning-series-build-an-automated-machine-learning-system-015, eval = FALSE}
instance = tune(
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-016, fig.width=10}
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-017}
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-018, echo = FALSE}
rr = readRDS("data/rr_1.rda")
```

```{r practical-tuning-series-build-an-automated-machine-learning-system-019, eval = FALSE}
graph_learner = GraphLearner$new(graph)
graph_learner$param_set$values$branch.selection = to_tune(c("kknn", "svm", "ranger"))
graph_learner$param_set$values$kknn.k = to_tune(p_int(3, 50, logscale = TRUE, depends = branch.selection == "kknn"))
graph_learner$param_set$values$svm.cost = to_tune(p_dbl(-1, 1, trafo = function(x) 10^x, depends = branch.selection == "svm"))
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-020}
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-021}
rr$score()
```
