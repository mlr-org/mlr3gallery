...
Currently `r mlr_pkg("mlr3pipelines")`  offers two main strategies towards adjusting `classification thresholds`.
...
```{r 2020-10-14-threshold-tuning-009, eval = FALSE}
l$param_set
```

```{r 2020-10-14-threshold-tuning-010, echo = FALSE}
...
```{r 2020-10-14-threshold-tuning-016, eval = FALSE}
l2$param_set
```

```{r 2020-10-14-threshold-tuning-017, echo = FALSE}
...
```{r 2020-10-14-threshold-tuning-018}
...
```{r 2020-10-14-threshold-tuning-019, eval = FALSE}
bmr$aggregate(list(msr("classif.ce"), msr("classif.fnr")))
```

```{r 2020-10-14-threshold-tuning-020, echo = FALSE}
bmr$aggregate(list(msr("classif.ce"), msr("classif.fnr")))[,.SD, .SDcols = !c("resample_result")] %>%
  kable(format = "html") %>%
  kable_styling(full_width = TRUE)
```
