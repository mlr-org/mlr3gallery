...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-001_tutorial_german_credit-001, include=FALSE}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-002_tutorial_german_credit-002, message=FALSE, warning=FALSE}
library("data.table")
library("ggplot2")
library("mlr3")
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-003_tutorial_german_credit-003, include=FALSE}
theme_set(theme_light())
```

We use the same `Task` as in Part I:

```{r 2020-03-11-mlr3tuning_tutorial_german_credit-004_tutorial_german_credit-004, message=FALSE}
task = tsk("german_credit")
```

We also might want to use multiple cores to reduce long run times of tuning runs.

```{r 2020-03-11-mlr3tuning_tutorial_german_credit-005_tutorial_german_credit-005, warning=FALSE}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-006_tutorial_german_credit-006}
set.seed(8008135)
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-007_tutorial_german_credit-007}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-008_tutorial_german_credit-008}
knn$param_set
```
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-009_tutorial_german_credit-009}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-010_tutorial_german_credit-010}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-011_tutorial_german_credit-011}
set.seed(1)
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-012_tutorial_german_credit-012}
instance_grid$result
```

Now, we tune:

```{r 2020-03-11-mlr3tuning_tutorial_german_credit-013_tutorial_german_credit-013}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-014_tutorial_german_credit-014}
instance_grid$result
```

We can also look at the `Archive` of evaluated configurations:

```{r 2020-03-11-mlr3tuning_tutorial_german_credit-015_tutorial_german_credit-015}
as.data.table(instance_grid$archive)
```

We plot the performances depending on the sampled `k` and `distance`:

```{r 2020-03-11-mlr3tuning_tutorial_german_credit-016_tutorial_german_credit-016}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-017_tutorial_german_credit-017}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-018_tutorial_german_credit-018}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-019_tutorial_german_credit-019}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-020_tutorial_german_credit-020}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-021_tutorial_german_credit-021}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-022_tutorial_german_credit-022}
ggplot(as.data.table(instance_random$archive),
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-023_tutorial_german_credit-023}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-024_tutorial_german_credit-024, eval=FALSE}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-025_tutorial_german_credit-025, eval=FALSE}
rr = resample(task, grid_auto, cv10_instance, store_models = TRUE)
```

We aggregate the performances of all resampling iterations:

```{r 2020-03-11-mlr3tuning_tutorial_german_credit-026_tutorial_german_credit-026, echo=FALSE}
rr = readRDS("resample_result.rds")
```

```{r 2020-03-11-mlr3tuning_tutorial_german_credit-027_tutorial_german_credit-027}
rr$aggregate()
```
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-028_tutorial_german_credit-028}
rr$learners[[1]]
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-029_tutorial_german_credit-029, echo=FALSE, eval=FALSE}
set.seed(2409)
instance_random = TuningInstanceSingleCrit$new(
  task = task,
  learner = knn,
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-030_tutorial_german_credit-030, echo=FALSE}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-031_tutorial_german_credit-031}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-032_tutorial_german_credit-032}
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-033_tutorial_german_credit-033, warning=FALSE}
ggplot(perfdata, aes(x = x_domain_k, y = classif.ce, color = kernel,
...
```{r 2020-03-11-mlr3tuning_tutorial_german_credit-034_tutorial_german_credit-034, warning=FALSE}
