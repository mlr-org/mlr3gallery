...
```{r 2020-09-11-liver-patient-classification-019, echo=FALSE, eval = TRUE}
bmr = readRDS("bmr.RDS")
```

```{r 2020-09-11-liver-patient-classification-020, echo = TRUE, results = 'hide', warning = FALSE, eval= FALSE}
set.seed(123)
...
lapply(setNames(1:14, names), function(x) ftable(bmr$resample_result(x)$prediction()$confusion))
```
