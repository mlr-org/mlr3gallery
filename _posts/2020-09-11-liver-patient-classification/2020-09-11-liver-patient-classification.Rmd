...
```{r 2020-09-11-liver-patient-classification-003, include=FALSE}
# Importing data
...
```{r 2020-09-11-liver-patient-classification-010, include=FALSE}
...
ilpd_log = ilpd %>%
  ...
  mutate(
    ...
    diseased = factor(ifelse(diseased == "yes", 1, 0)), # Remove labels for class
...
## Task definition
task_liver = TaskClassif$new(id = "task_liver", backend = ilpd_log, target = "diseased", positive = "1")
```
...
```{r 2020-09-11-liver-patient-classification-019, echo=FALSE, eval=!params$evaluate_all}
bmr = readRDS("bmr.RDS")
```

```{r 2020-09-11-liver-patient-classification-020, echo = TRUE, results = 'hide', warning = FALSE, eval=params$evaluate_all}
set.seed(123)
...
```{r 2020-09-11-liver-patient-classification-021, echo=FALSE}
...
```{r 2020-09-11-liver-patient-classification-022, echo=FALSE, fig.height = 6, fig.width = 12, out.width='95%', fig.align="center"}
...
```{r 2020-09-11-liver-patient-classification-023, echo=FALSE, out.width='85%', fig.align="center"}
# Plotting ROC curves
...
```{r 2020-09-11-liver-patient-classification-024, echo=FALSE}
...
```{r 2020-09-11-liver-patient-classification-025, echo=FALSE, out.width='90%', fig.align="center"}
...
```{r 2020-09-11-liver-patient-classification-026, echo=FALSE, out.width='75%', fig.align="center"}
...
```{r 2020-09-11-liver-patient-classification-027, results='asis', echo=FALSE, out.extra=''}
