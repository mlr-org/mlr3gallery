...
```{r regression-chains-010, eval = FALSE}
setorder(data, y3)
...
```{r regression-chains-011, eval = FALSE}
setorder(data, y3)
...
```{r regression-chains-013, fig.width=10, fig.height=10}
...
```{r regression-chains-020, fig.width=10, fig.height=10}
