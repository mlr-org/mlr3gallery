...
```{r 2020-05-04-moneyball-004, eval = FALSE}
head(as.data.table(oml_data))
```

```{r chunk-name-s2, layout="l-page", echo = FALSE}
head(as.data.table(oml_data)) %>%
  kable(format = "html") %>%
...
`r mlr_pkg("mlr3")` has some solutions for that within the `mlr3pipelines` package.
...
```{r 2020-05-04-moneyball-009, fig.width=10, fig.height=10}
...
```{r 2020-05-04-moneyball-010, results = 'hide'}
...
```{r 2020-05-04-moneyball-010ss, echo = FALSE}
t(task$missings()) %>%
  kable(format = "html") %>%
  kable_styling(full_width = TRUE)
```
...
```{r 2020-05-04-moneyball-013, fig.width=10, fig.height=10}
...
```{r 2020-05-04-moneyball-014, results = 'hide'}
...
```{r 2020-05-04-moneyball-016, eval = FALSE}
...
```{r 2020-05-04-moneyball-017, eval = FALSE}
rr$score(msrs(c("regr.mae", "regr.mse")))
```

```{r mlr3fselect-basic-027s, echo = FALSE, layout="l-body-outset"}
...
```{r 2020-05-04-moneyball-023, eval = FALSE}
sort(graph_learner$model$regr.ranger$model$variable.importance, decreasing = TRUE)
```


```{r 2020-05-04-moneyball-02ss3, echo = FALSE, layout="l-body-outset"}
