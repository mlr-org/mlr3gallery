...
```{r 2020-01-30-house-prices-in-king-county-024, echo=FALSE, results = 'hide'}
  eval_tune = TRUE
```
...
```{r 2020-01-30-house-prices-in-king-county-025, eval = eval_tune}
set.seed(444L)
library(mlr3tuning)
library(paradox)
...
```{r 2020-01-30-house-prices-in-king-county-026, echo = FALSE, results = 'hide', eval = eval_tune}
# And resample the AutoTuner
res = resample(tsk_nozip, at, cv3, store_models = TRUE)
```

```{r 2020-01-30-house-prices-in-king-county-027, eval = eval_tune}
res$score(msr("regr.rmse"))
...
```{r 2020-01-30-house-prices-in-king-county-028, eval = eval_tune}
