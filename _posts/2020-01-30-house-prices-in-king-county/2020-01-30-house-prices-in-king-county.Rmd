...
saveRDS(res, here::here("_posts/2020-01-30-house-prices-in-king-county/data/res.rda"))
```

```{r 2020-01-30-house-prices-in-king-county-028, echo = FALSE}
res = readRDS(here::here("_posts/2020-01-30-house-prices-in-king-county/data/res.rda"))
```
...
saveRDS(res, here::here("_posts/2020-01-30-house-prices-in-king-county/data/res2.rda"))
```

```{r 2020-01-30-house-prices-in-king-county-034, echo = FALSE}
res = readRDS(here::here("_posts/2020-01-30-house-prices-in-king-county/data/res2.rda"))
```
...
saveRDS(res, here::here("_posts/2020-01-30-house-prices-in-king-county/data/res3.rda"))
```

```{r 2020-01-30-house-prices-in-king-county-039, echo = FALSE}
res = readRDS(here::here("_posts/2020-01-30-house-prices-in-king-county/data/res3.rda"))
```
