...
```{r 2020-01-30-house-prices-in-king-county-007, message = FALSE}
library(anytime)
...
```{r 2020-01-30-house-prices-in-king-county-018, fig.width=10, fig.height=8}
...
```{r 2020-01-30-house-prices-in-king-county-021}
...
```{r 2020-01-30-house-prices-in-king-county-022, fig.width=10, fig.height=8}
plot(lrn$model)
text(lrn$model)
```
...
```{r 2020-01-30-house-prices-in-king-county-023, message = FALSE}
...
```{r 2020-01-30-house-prices-in-king-county-028, eval = params$eval_all}
# And resample the AutoTuner
res = resample(tsk_nozip, at, cv3, store_models = TRUE)
```

```{r 2020-01-30-house-prices-in-king-county-029, echo = FALSE, eval = params$eval_all}
saveRDS(res, "data/res.rda")
```

```{r 2020-01-30-house-prices-in-king-county-030, echo = FALSE}
res = readRDS("data/res.rda")
```
...
```{r 2020-01-30-house-prices-in-king-county-034, eval = params$eval_all}
res = resample(task = task_train, lrn_impact, cv3)
```

```{r 2020-01-30-house-prices-in-king-county-035, echo = FALSE, eval = params$eval_all}
saveRDS(res, "data/res2.rda")
```

```{r 2020-01-30-house-prices-in-king-county-036, echo = FALSE}
res = readRDS("data/res2.rda")
```
...
For a more in-depth insight, refer to the sections on `r mlr_pkg("mlr3pipelines")`  and `mlr3filters` in the **mlr3 book**: [Feature Selection](https://mlr3book.mlr-org.com/fs.html) and [Pipelines](https://mlr3book.mlr-org.com/pipelines.html).

```{r 2020-01-30-house-prices-in-king-county-038}
filter = flt("mrmr")
```

The resulting **RMSE** is slightly higher, and at the same time we only use $12$ features.

```{r 2020-01-30-house-prices-in-king-county-039, eval = params$eval_all}
...
```{r 2020-01-30-house-prices-in-king-county-040, echo = FALSE, eval = params$eval_all}
saveRDS(res, "data/res3.rda")
```

```{r 2020-01-30-house-prices-in-king-county-041, echo = FALSE}
res = readRDS("data/res3.rda")
```
...
```{r 2020-01-30-house-prices-in-king-county-043}
...
```{r 2020-01-30-house-prices-in-king-county-044}
