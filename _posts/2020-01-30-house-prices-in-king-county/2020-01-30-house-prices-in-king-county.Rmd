...
```{r 2020-01-30-house-prices-in-king-county-004, message = FALSE}
library(anytime)
...
```{r 2020-01-30-house-prices-in-king-county-019, width = 10, height = 10}
plot(lrn$model)
text(lrn$model)
```
...
```{r 2020-01-30-house-prices-in-king-county-020, message = FALSE}
...
```{r 2020-01-30-house-prices-in-king-county-03077, eval = params$eval_all}
res = resample(task = task_train, lrn_impact, cv3)
```

```{r chunk-name1sd, echo = FALSE, eval = params$eval_all}
saveRDS(res, "data/res2.rda")
```

```{r chunk-name1223, echo = FALSE}
res = readRDS("data/res2.rda")
```

```{r 2020-01-30-house-prices-in-king-county-030sdsd}
res$score(msr("regr.rmse"))
...
```{r chunk-name1, echo = FALSE, eval = params$eval_all}
saveRDS(res, "data/res3.rda")
```

```{r chunk-name12, echo = FALSE}
