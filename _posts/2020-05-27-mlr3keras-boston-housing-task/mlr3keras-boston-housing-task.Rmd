---
title: "mlr3keras: Boston Housing Task"
...
Callback can also be called through `r gh_pkg("mlr-org/mlr3keras")` syntax.
...
Currently working callbacks within `r gh_pkg("mlr-org/mlr3keras")`-syntax  are:
