...
```{r 2020-04-23-pipelines-selectors-branches-001, include=FALSE}
...
`r mlr_pkg("mlr3pipelines")`  offers a very flexible way to create data preprocessing steps.
...
```{r 2020-04-23-pipelines-selectors-branches-007}
...
```{r 2020-04-23-pipelines-selectors-branches-008, fig.height = 10, fig.width = 10}
...
```{r 2020-04-23-pipelines-selectors-branches-009, eval = FALSE}
head(miss_ind$train(list(task_pima))[[1]]$data())
```

```{r 2020-04-23-pipelines-selectors-branches-010, echo = FALSE}
head(miss_ind$train(list(task_pima))[[1]]$data()) %>%
  kable(format = "html") %>%
...
```{r 2020-04-23-pipelines-selectors-branches-011, fig.height = 10, fig.width = 10}
...
```{r 2020-04-23-pipelines-selectors-branches-012, eval = FALSE}
head(impute_missind$train(task_pima)[[1]]$data())
```

```{r 2020-04-23-pipelines-selectors-branches-013, echo = FALSE, layout="l-page"}
head(impute_missind$train(task_pima)[[1]]$data()) %>%
  kable(format = "html") %>%
  kable_styling(full_width = TRUE)
```
...
```{r 2020-04-23-pipelines-selectors-branches-015, eval = FALSE}
head(imputer_hist_2$train(task_pima)[[1]]$data())
```

```{r 2020-04-23-pipelines-selectors-branches-016, echo = FALSE}
head(imputer_hist_2$train(task_pima)[[1]]$data()) %>%
  kable(format = "html") %>%
  kable_styling(full_width = TRUE)
```

```{r 2020-04-23-pipelines-selectors-branches-017, results = 'hide'}
imputer_median_2 =
...
```{r 2020-04-23-pipelines-selectors-branches-018, echo = FALSE}
head(imputer_median_2$train(task_pima)[[1]]$data()) %>%
  kable(format = "html") %>%
  kable_styling(full_width = TRUE)
```
...
```{r 2020-04-23-pipelines-selectors-branches-019, fig.height = 6, fig.width = 6}
...
imputer_missind_2$plot()
```

```{r 2020-04-23-pipelines-selectors-branches-020, eval = FALSE}
head(imputer_missind_2$train(task_pima)[[1]]$data())
```

```{r 2020-04-23-pipelines-selectors-branches-021, echo = FALSE, layout="l-page"}
head(imputer_missind_2$train(task_pima)[[1]]$data()) %>%
  kable(format = "html") %>%
  kable_styling(full_width = TRUE)
```
...
```{r 2020-04-23-pipelines-selectors-branches-022, results = 'hide'}
...
```{r 2020-04-23-pipelines-selectors-branches-023, echo = FALSE, layout="l-page"}
head(imputer_missind_3$train(task_pima)[[1]]$data()) %>%
  kable(format = "html") %>%
  kable_styling(full_width = TRUE)
```
...
```{r 2020-04-23-pipelines-selectors-branches-024, fig.height = 7, fig.width = 7}
...
```{r 2020-04-23-pipelines-selectors-branches-025, fig.height = 7, fig.width = 7}
graph = graph_branch %>>%
  lrn("classif.rpart")
...
```{r 2020-04-23-pipelines-selectors-branches-026, eval = FALSE}
as.data.table(graph$param_set)
```

```{r 2020-04-23-pipelines-selectors-branches-027, echo = FALSE}
...
```{r 2020-04-23-pipelines-selectors-branches-028}
search_space = ps(
...
```{r 2020-04-23-pipelines-selectors-branches-029, results = 'hide'}
...
```{r 2020-04-23-pipelines-selectors-branches-030, echo = FALSE}
...
```{r 2020-04-23-pipelines-selectors-branches-031}
instance$result
```
