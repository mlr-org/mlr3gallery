...
```{r 2020-02-01-tuning-multiplexer-004, fig.width = 10, fig.height = 8}
graph =
...
```{r 2020-02-01-tuning-multiplexer-006, results = "hide"}
...
```{r 2020-02-01-tuning-multiplexer-007, echo = FALSE}
...
```{r 2020-02-01-tuning-multiplexer-008, eval = params$eval_all}
at = auto_tuner(
  method = "grid_search",
  learner = graph_learner,
  resampling = inner_cv2,
...
```{r mlr3fselect-basic-02322, echo = FALSE, eval = params$eval_all}
saveRDS(rr, "data/rr.rda")
```

```{r mlr3fselect-basic-02422, echo = FALSE}
...
```{r 2020-02-01-tuning-multiplexer-010, results = 'hide'}
# access inner tuning archives
extract_inner_tuning_archives(rr)
```

```{r 2020-02-01-tuning-multiplexer-011, echo = FALSE, layout="l-page"}
...
```{r 2020-02-01-tuning-multiplexer-012, eval = FALSE}
...
```{r 2020-02-01-tuning-multiplexer-014, eval = params$eval_all}
graph_learner = as_learner(graph)
graph_learner$id = "g"
...
```{r mlr3fselect-basic-0232552, echo = FALSE, eval = params$eval_all}
saveRDS(instance, "data/instance.rda")
```

```{r mlr3fselect-basic-0245522, echo = FALSE}
...
```{r 2020-02-01-tuning-multiplexer-016, fig.width=10, fig.height=5}
autoplot(instance, cols_x = c("xgb.nrounds","rf.mtry")) 
```

Nested resampling, now really needed:

```{r 2020-02-01-tuning-multiplexer-017, eval = params$eval_all}
rr = tune_nested(
  method = "grid_search",
  task = task,
  learner = graph_learner,
...
```{r mlr3fselect-basic-02444, eval = FALSE}
# access inner tuning result
extract_inner_tuning_results(rr)
```

```{r 2020-02-01-tuning-multiplexer-018, echo = FALSE}
extract_inner_tuning_results(rr) %>%
  kable(format = "html") %>%
  kable_styling()
```
