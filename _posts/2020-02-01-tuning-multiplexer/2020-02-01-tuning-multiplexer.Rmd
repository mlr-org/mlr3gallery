...
* `r ref("mlr_pipelines_branch", text = "branch")` pipes incoming data to one of the following elements, on different data channels. We can name these channel on construction with `options`.
* our learners (combined with `r ref("gunion")`)
* `r ref("mlr_pipelines_unbranch", text = "unbranch")` combines the forked paths at the end.
