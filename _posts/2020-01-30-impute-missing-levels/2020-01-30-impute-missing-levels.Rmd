...
```{r 2020-01-30-impute-missing-levels-006, message = FALSE, warning = FALSE, fig.width=10, fig.height=8}
...
```{r 2020-01-30-impute-missing-levels-014, fig.width=10, fig.height=8}
graph$plot()
```
