...
`r ref("Resampling")` simply repeats the train-predict-score loop and collects all results in a nice `r ref("data.table")`.

```{r 2020-03-18-iris-mlr3-basics-007, size = "tiny"}
...
```{r 2020-03-18-iris-mlr3-basics-008, message = FALSE}
