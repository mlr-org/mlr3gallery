...
* [R can API and So Can You!](https://medium.com/tmobile-tech/using-docker-to-deploy-an-r-plumber-api-863ccf91516d)
...
All files presented in this tutorial are available [here](https://github.com/mlr-org/mlr3gallery/_posts/2020-06-22-a-production-example-using-plumber-and-docker/mlr3_api).
