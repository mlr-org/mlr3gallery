...
In the example, we use the [pima indian diabetes data set](https://mlr3.mlr-org.com/reference/mlr_tasks_pima.html)(pima) which is used to to predict whether or not a patient has diabetes.
The patients are characterized by 8 numeric features and some have missing values.
The pima data set allows us to quickly fit models to it.
