...
The package `r mlr_pkg("mlr3tuningspaces")` offers a collection of search spaces for the most commonly machine learning algorithms.
...
The list of of `r ref("TuneToken")` can be directly applied to the `$values` slot of a learner's [paradox::ParamSet].
