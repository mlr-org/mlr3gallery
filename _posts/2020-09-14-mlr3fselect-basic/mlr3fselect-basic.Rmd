...
```{r mlr3fselect-basic-019, eval = params$eval_all}
resampling_outer = rsmp("cv", folds = 3)

rr = resample(task, at, resampling_outer, store_models = TRUE)
```

```{r mlr3fselect-basic-020, echo = FALSE, eval = params$eval_all}
saveRDS(rr, "data/rr.rda")
```

```{r mlr3fselect-basic-021, echo = FALSE}
...
The archive of the `r ref("AutoFSelector")` gives us all evaluated hyperparameter configurations (i.e. feature sets) with the associated predictive performances.
