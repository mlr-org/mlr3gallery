...
```{r mlr3fselect-basic-021, eval = params$eval_all}
resampling_outer = rsmp("cv", folds = 3)

rr = resample(task, at, resampling_outer, store_models = TRUE)
```

```{r mlr3fselect-basic-022, echo = FALSE, eval = params$eval_all}
saveRDS(rr, "data/rr.rda")
```

```{r mlr3fselect-basic-023, echo = FALSE}
