...
FSelectInstanceSingleCrit$new(task, learner, resampling, measure, terminator)
```
...
terminator = trm("none")
instance = FSelectInstanceSingleCrit$new(task, learner, resampling, measure, terminator, store_models = TRUE)
